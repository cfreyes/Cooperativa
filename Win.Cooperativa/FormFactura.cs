...
namespace Win.Cooperativa
{
    public partial class FormFactura : Form
    {
        ...
        public FormFactura()
        {
            ...
            _depositosBL = new DepositosBL();
            listaDepositosBindingSource.DataSource = _depositosBL.ObtenerDeposito();
        }
        ...
        {
            var factura = (Factura)listaFacturasBindingSource.Current;
            var facturaDetalle = (FacturaDatalle)facturaDetalleBindingSource.Current;
